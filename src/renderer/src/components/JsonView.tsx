  ...
  return (
    <div className="json-view" {...props}>
      <div className="button-container">
        ...
        {showVisualize && (
          <IconButton onClick={() => onShowVisualize?.apply(null)} title="View on Map">
            <AddLocationAltIcon />
          </IconButton>
        )}
      </div>
      <JSONTree data={data} hideRoot={true} theme={theme} invertTheme={!isDarkTheme} shouldExpandNodeInitially={(_, __, l) => l < 3} />
    </div>
  )
}
